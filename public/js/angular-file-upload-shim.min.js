...
!function () {
    if (window.XMLHttpRequest) {
        if (window.FormData)window.XMLHttpRequest = function (a) {
            return function () {
                var b = new a;
            ...
            window.XMLHttpRequest = function (b) {
                return function () {
                    var c = new b, d = c.send;
                    return c.__requestHeaders = [], c.open = function (a) {
                        return c.upload || (c.upload = {}), c.upload.addEventListener = function (a, b) {
                            "progress" === a && (c.__progress = b), "load" === a && (c.__load = b)
                        }, function (b, d, e) {
                            a.apply(c, [b, d, e]), c.__url = d
                        }
                    }(c.open), c.getResponseHeader = function (a) {
                        return function (b) {
                            return c.__fileApiXHR ? c.__fileApiXHR.getResponseHeader(b) : a.apply(c, [b])
                        }
                    }(c.getResponseHeader), c.getAllResponseHeaders = function (a) {
                        return function () {
                            return c.__fileApiXHR ? c.__fileApiXHR.getAllResponseHeaders() : a.apply(c)
                        }
                    }(c.getAllResponseHeaders), c.abort = function (a) {
                        return function () {
                            return c.__fileApiXHR ? c.__fileApiXHR.abort() : null == a ? null : a.apply(c)
                        }
                    }(c.abort), c.setRequestHeader = function (a) {
                        return function (b, d) {
                            if ("__setXHR_" === b) {
                                var e = d(c);
                                e instanceof Function && e(c)
                            } else a.apply(c, arguments)
                        }
                    }(c.setRequestHeader), c.send = function () {
                        if (arguments[0] && arguments[0].__isShim) {
                            var b = arguments[0], e = {url: c.__url, complete: function (a, b) {
                                a || c.__load({type: "load", loaded: c.__total, total: c.__total, target: c, lengthComputable: !0}), void 0 !== b.status && Object.defineProperty(c, "status", {get: function () {
                                    return b.status
                                ...
                                a.target = c, c.__progress(a), c.__total = a.total
                            ...
                            setTimeout(function () {
                                a || alert("Please install Adode Flash Player to upload files."), c.__fileApiXHR = FileAPI.upload(e)
                            }, 1)
                        } else d.apply(c, arguments)
                    }, c
                }
            }(window.XMLHttpRequest), window.XMLHttpRequest.__hasFlash = a
        }
    ...
    if (!window.FormData) {
        var d = function (a) {
            if (!a.__isWrapped && (null != a.getAttribute("ng-file-select") || null != a.getAttribute("data-ng-file-select"))) {
                ...
                b.innerHTML = '<div class="js-fileapi-wrapper" style="position:relative; overflow:hidden"></div>', b = b.firstChild;
                var c = a.parentNode;
                c.insertBefore(b, a), c.removeChild(a), b.appendChild(a), a.__isWrapped = !0
            }
        }, e = function (a) {
            return function (b) {
        ...
        HTMLInputElement.prototype.addEventListener && (HTMLInputElement.prototype.addEventListener = function (a) {
            ...
            if (window.FileAPI || (window.FileAPI = {}), !FileAPI.upload) {
                var a, b, c, d, e, f = document.createElement("script"), g = document.getElementsByTagName("script");
                if (window.FileAPI.jsUrl)a = window.FileAPI.jsUrl; else if (window.FileAPI.jsPath)b = window.FileAPI.jsPath; else for (c = 0; c < g.length; c++)if (e = g[c].src, d = e.indexOf("angular-file-upload-shim.js"), -1 == d && (d = e.indexOf("angular-file-upload-shim.min.js")), d > -1) {
                    b = e.substring(0, d);
                    break
                }
                null == FileAPI.staticPath && (FileAPI.staticPath = b), f.setAttribute("src", a || b + "FileAPI.min.js"), document.getElementsByTagName("head")[0].appendChild(f)
            }
        }()
    }
    window.FileReader || (window.FileReader = function () {
        function a(a, c) {
            var d = {type: a, target: b, loaded: c.loaded, total: c.total, error: c.error};
