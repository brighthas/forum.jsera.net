...
(function (D, T, s) {
    ...
    function F(b) {
        return function () {
            var a = arguments[0], c, a = "[" + (b ? b + ":" : "") + a + "] http://errors.angularjs.org/1.2.15-build.2363+sha.bf82c8a/" + (b ? b + "/" : "") + a;
    ...
    var Vc = /[A-Z]/g, Xd = {full: "1.2.15-build.2363+sha.bf82c8a", major: 1, minor: 2, dot: 15, codeName: "snapshot"}, Ra = R.cache = {}, db = R.expando = "ng-" + (new Date).getTime(), Zc = 1, Kc = D.document.addEventListener ? function (b, a, c) {
            b.addEventListener(a, c, !1)
        } : function (b, a, c) {
            b.attachEvent("on" + a, c)
        },
        Db = D.document.removeEventListener ? function (b, a, c) {
    ...
    r({data: dc, inheritedData: gb, scope: function (b) {
        ...
        controller: ec, injector: function (b) {
            ...
            var d = O(a);
            if (hb[d])if (v(c))c ? (b[a] = !0, b.setAttribute(a, d)) : (b[a] = !1, b.removeAttribute(d)); else return b[a] || (b.attributes.getNamedItem(a) || x).specified ? d : s; else if (v(c))b.setAttribute(a, c);
        ...
        r(d.split(" "), function (d) {
            ...
            if (!f) {
                if ("mouseenter" == d || "mouseleave" == d) {
                    ...
                    g[d] = [];
                    a(c,
                        {mouseleave: "mouseout", mouseenter: "mouseover"}[d], function (a) {
