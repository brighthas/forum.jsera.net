...
!function () {
    ...
    a.service("$upload", ["$http", "$rootScope", "$timeout", function (a, b, c) {
        function d(b) {
            ...
            return d.progress = function (a) {
                ...
                return function (d, e, f) {
                    b.progress = f || b.progress;
                    var g = c.apply(a, [d, e, f]);
                    return g.abort = a.abort, g.progress = a.progress, g
                }
            }(d, d.then), d
        }
        ...
        this.upload = function (b) {
            ...
            var c = new FormData;
            if (b.data)for (var e in b.data) {
                var f = b.data[e];
                if (b.formDataAppender)b.formDataAppender(c, e, f); else {
                    if ("function" == typeof b.transformRequest)f = b.transformRequest(f); else for (var g = 0; g < b.transformRequest.length; g++) {
            ...
            if ("[object Array]" === Object.prototype.toString.call(b.file))for (var j = "[object String]" === Object.prototype.toString.call(i), g = 0; g < b.file.length; g++)c.append(j ? i + g : i[g], b.file[g], b.file[g].name); else c.append(i, b.file, b.file.name);
            return b.data = c, d(b)
        ...
        return function (b, d, e) {
            if ("draggable"in document.createElement("span")) {
                var f = null, g = a(e.ngFileDrop);
                d[0].addEventListener("dragover", function (a) {
                    c.cancel(f), a.stopPropagation(), a.preventDefault(), d.addClass(e.ngFileDragOverClass || "dragover")
                    ...
                    var f, h = [], i = a.dataTransfer.files;
                    if (null != i)for (f = 0; f < i.length; f++)h.push(i.item(f));
                    c(function () {
                        g(b, {$files: h, $event: a})
                    })
                }, !1)
